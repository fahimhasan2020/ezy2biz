...
@section('body')
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Point Requests</li>
        </ol>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="text-right">Sent Amount</th>
                            <th scope="col" class="text-right">bKash No.</th>
                            <th scope="col" class="text-center">Allowed Points</th>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <form class="d-inline" action="/a/point-requests" method="post">
                                                @csrf
                                                <input type="hidden" name="request-id" value="{{ $request->id }}">
